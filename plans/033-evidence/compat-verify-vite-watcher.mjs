...
import { child, config, dist, equal, evidence, filesUnder, identity, json, metadata, modes, observeExtractions, options, raw, removeFixture, require, writeJson } from "./compat-common.mjs";
